---
description: Worked examples showing the same Codex Batman backbone through learning, execution, and manager lenses.
---

# Examples

These examples make the backbone concrete.

The point is not to show three unrelated systems. The point is to show that the same artifact-first backbone can be viewed through different lenses:
